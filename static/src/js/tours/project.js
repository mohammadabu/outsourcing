odoo.define('outsourcing.tour', function(require) {
"use strict";
...
tour.register('outsourcing_tour', {
    url: "/web",
}, [tour.STEPS.SHOW_APPS_MENU_ITEM, {
    trigger: '.o_app[data-menu-xmlid="outsourcing.menu_main_pm"]',
    content: _t('Want a better way to <b>manage your outsourcings</b>? <i>It starts here.</i>'),
    position: 'right',
    edition: 'community',
}, {
    trigger: '.o_app[data-menu-xmlid="outsourcing.menu_main_pm"]',
    ...
    extra_trigger: '.o_outsourcing_kanban',
    content: _t('Let\'s create your first outsourcing.'),
    position: 'bottom',
    width: 200,
}, {
    trigger: 'input.o_outsourcing_name',
    content: _t('Choose a <b>outsourcing name</b>. (e.g. Website Launch, Product Development, Office Party, etc.)'),
    position: 'right',
}, {
    trigger: '.o_open_tasks',
    content: _t('This will create a new outsourcing and redirect us to its stages.'),
    position: 'top',
    run: function (actions) {
        actions.auto('.modal:visible .btn.btn-primary');
    },
}, {
    trigger: ".o_kanban_outsourcing_tasks .o_column_quick_create input",
    content: _t("Add columns to configure <b>stages for your tasks</b>.<br/><i>e.g. New - In Progress - Done</i>"),
    position: "bottom",
}, {
    trigger: ".o_kanban_outsourcing_tasks .o_column_quick_create .o_kanban_add",
    auto: true,
}, {
    trigger: ".o_kanban_outsourcing_tasks .o_column_quick_create input",
    content: _t("Add columns to configure <b>stages for your tasks</b>.<br/><i>e.g. New - In Progress - Done</i>"),
    ...
    trigger: '.o-kanban-button-new',
    extra_trigger: '.o_kanban_outsourcing_tasks',
    ...
    extra_trigger: '.o_form_outsourcing_tasks',
    content: _t('Click on this button to modify the task.'),
    position: "bottom"
}, {
    trigger: ".o_form_view .o_task_user_field",
    extra_trigger: '.o_form_outsourcing_tasks.o_form_editable',
    ...
    extra_trigger: '.o_form_outsourcing_tasks.o_form_readonly',
